...
class WitnessWebIterator {
    ...
    constructor(pe, allCoveredTiles, rotation) {
        ...
        if (
            this.probabilityEngine.minesLeft - indMines > this.probabilityEngine.tilesLeft - indSquares ||
        ...
        if (this.probabilityEngine.minesLeft > indMines) {
            ...
            this.cogs.push(
                new SequentialIterator(
                    this.probabilityEngine.minesLeft - indMines,
                    this.probabilityEngine.tilesLeft - indSquares,
                ),
            )

            this.cycles =
                this.cycles *
                combination(this.probabilityEngine.minesLeft - indMines, this.probabilityEngine.tilesLeft - indSquares)
        }
